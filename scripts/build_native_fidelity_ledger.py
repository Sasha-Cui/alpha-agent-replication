...
ARTIFACT_NOTES = {
    "SYS-FIN-ANALYST": (
        ...
        "decisions, and its pinned scorer replays all 97. In total, 19/119 printed table "
        ...
        "plus all 14 cells in both offline Buy-and-Hold rows. The baseline rows require "
        "different later official revisions: TSLA ends May 20 with 293 rows and BTC ends "
        "May 21 with 294, contradicting the common May 10 endpoint printed in the paper. "
        ...
        "The displayed N_tr values are total dataset rows, not executed trades. Native BTC "
...
TARGETED_EXECUTION = {
    ...
    "SYS-FIN-ANALYST": "paper_audit:partial_19_of_119_displayed_cells_regenerated_14_offline_baseline_mixed_endpoints_5_live_output_verified_97_official_decisions_replayed_zero_end_to_end_full_5_103_327_commit_histories_exhausted",
