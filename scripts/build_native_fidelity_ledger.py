...
PAPER_ONLY_AUDIT_NOTES = {
    ...
    "SYS-EFS": (
        ...
        "supplement paths equal the mirror bit-for-bit; the discrepancy is specific to "
        "EFS's undisclosed baseline protocol. Combined credit is 6/773 v1 and 11/877 "
        "v2 cells; all are cited-baseline evidence and zero are native EFS "
