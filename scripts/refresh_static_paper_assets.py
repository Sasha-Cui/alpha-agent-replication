...
def computed_macros(
    ...
    expected = {
        ...
        "ArtifactCountFT": "32",
        "ReachableArtifactCountFT": "31",
        "LicensedArtifactCountFT": "18",
        "PinnedRepoCountFT": "30",
        "ArtifactTierSummaryFT": r"\artifacttier{R0}: 36, \artifacttier{R1}: 9, \artifacttier{R2}: 6, \artifacttier{R3}: 16",
        "TargetedAuditCount": "49",
