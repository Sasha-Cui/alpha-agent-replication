...
def computed_macros(
    ...
    expected = {
        ...
        "ArtifactCountFT": "30",
        "ReachableArtifactCountFT": "29",
        "LicensedArtifactCountFT": "17",
        "PinnedRepoCountFT": "28",
        "ArtifactTierSummaryFT": r"\artifacttier{R0}: 38, \artifacttier{R1}: 9, \artifacttier{R2}: 6, \artifacttier{R3}: 14",
        "TargetedAuditCount": "47",
