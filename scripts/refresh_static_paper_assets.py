...
def computed_macros(
    ...
    expected = {
        ...
        "ArtifactCountFT": "23",
        "ReachableArtifactCountFT": "22",
        "LicensedArtifactCountFT": "12",
        "PinnedRepoCountFT": "22",
        "ArtifactTierSummaryFT": r"\artifacttier{R0}: 45, \artifacttier{R1}: 7, \artifacttier{R2}: 5, \artifacttier{R3}: 10",
        "TargetedAuditCount": "31",
