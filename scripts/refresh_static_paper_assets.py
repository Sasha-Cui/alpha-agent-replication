...
def computed_macros(
    ...
    expected = {
        ...
        "ArtifactCountFT": "21",
        "ReachableArtifactCountFT": "20",
        "LicensedArtifactCountFT": "11",
        "PinnedRepoCountFT": "20",
        "ArtifactTierSummaryFT": r"\artifacttier{R0}: 47, \artifacttier{R1}: 6, \artifacttier{R2}: 5, \artifacttier{R3}: 9",
        "TargetedAuditCount": "28",
