...
def computed_macros(
    ...
    expected = {
        ...
        "ArtifactCountFT": "33",
        "ReachableArtifactCountFT": "32",
        "LicensedArtifactCountFT": "19",
        "PinnedRepoCountFT": "31",
        "ArtifactTierSummaryFT": r"\artifacttier{R0}: 35, \artifacttier{R1}: 10, \artifacttier{R2}: 6, \artifacttier{R3}: 16",
        "TargetedAuditCount": "50",
