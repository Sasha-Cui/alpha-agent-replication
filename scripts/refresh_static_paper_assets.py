...
def computed_macros(
    ...
    expected = {
        ...
        "ArtifactCountFT": "31",
        "ReachableArtifactCountFT": "30",
        "LicensedArtifactCountFT": "17",
        "PinnedRepoCountFT": "29",
        "ArtifactTierSummaryFT": r"\artifacttier{R0}: 37, \artifacttier{R1}: 9, \artifacttier{R2}: 6, \artifacttier{R3}: 15",
        "TargetedAuditCount": "48",
