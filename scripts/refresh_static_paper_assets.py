...
def computed_macros(
    ...
    expected = {
        ...
        "ArtifactCountFT": "22",
        "ReachableArtifactCountFT": "21",
        "LicensedArtifactCountFT": "12",
        "PinnedRepoCountFT": "21",
        "ArtifactTierSummaryFT": r"\artifacttier{R0}: 46, \artifacttier{R1}: 6, \artifacttier{R2}: 5, \artifacttier{R3}: 10",
        "TargetedAuditCount": "29",
