...
def computed_macros(
    ...
    expected = {
        ...
        "ArtifactCountFT": "34",
        "ReachableArtifactCountFT": "33",
        "LicensedArtifactCountFT": "20",
        "PinnedRepoCountFT": "32",
        "ArtifactTierSummaryFT": r"\artifacttier{R0}: 34, \artifacttier{R1}: 10, \artifacttier{R2}: 6, \artifacttier{R3}: 17",
        "TargetedAuditCount": "55",
