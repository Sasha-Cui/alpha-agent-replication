...
PUBLIC_FORK_REST_COUNT = 1862
PUBLIC_FORK_ACCESSIBLE_COUNT = 1854
PUBLIC_FORK_BRANCH_REF_COUNT = 33775
PUBLIC_FORK_BRANCH_REF_SHA256 = "75b46af589246c73bc772cd5e510d5325f8f955661c99124a5995d39bfb0ad9d"
PUBLIC_FORK_SNAPSHOT_SHA256 = "d6b8de9a27ff01352e5e460ae524ed4eec76c9a593794c1dd7eacc5483dd2e2c"
PUBLIC_FORK_UNIQUE_HEAD_COUNT = 1261
PUBLIC_FORK_UNIQUE_HEAD_SHA256 = "77ab6ec73931fc177722f3fc8501c27611b33ff1f51a3960511b017360a1968f"
PUBLIC_OFFICIAL_UNIQUE_HEAD_COUNT = 229
PUBLIC_OFFICIAL_UNIQUE_HEAD_SHA256 = "c3c9e30fe5a77f7876734b1cd105f59dd36bf3b9d47af3288fea4cdfded25417"
PUBLIC_FORK_DIVERGENT_HEAD_COUNT = 619
PUBLIC_FORK_DIVERGENT_HEAD_SHA256 = "3b643465e3d4cfda53db2932e09dd7eb798c312bdafb4becac8eb1d7d8f1d296"
PUBLIC_FORK_EXTRA_COMMIT_COUNT = 4727
PUBLIC_FORK_EXTRA_COMMIT_SHA256 = "cf8cd5d03feb99f851e5ab1c79e1a2abafe64be95a306f75c6b47f00ba4a9a1e"
PUBLIC_FORK_CHANGED_PATH_COUNT = 6383
PUBLIC_FORK_CHANGED_PATH_SHA256 = "b14ee6c39dede82d0c0f2af99866a1a463310f6c376bbbbb27b44771b0b5abf6"
PUBLIC_FORK_CHANGED_NEW_BLOB_COUNT = 15752
PUBLIC_FORK_CHANGED_NEW_BLOB_SHA256 = "818685d6ff82a826cda48889f2615ec82eafde16c92efd1b03359e835c67cfaa"
PUBLIC_FORK_HIGH_RELEVANCE_BLOB_COUNT = 65
PUBLIC_FORK_HIGH_RELEVANCE_BLOB_SHA256 = "63709c1cd17169dfeed5c262814fbb85fb114b5948d256f74502d31d8b54419a"
PUBLIC_FORK_HIGH_RELEVANCE_PATH_COUNT = 56
PUBLIC_FORK_HIGH_RELEVANCE_PATH_SHA256 = "e5a4bacb8ef74a5e7be34888a52b9ee89f4d0c07f0fb0db6c73b88db2d5f3f7d"
PUBLIC_FORK_HIGH_RELEVANCE_BYTES = 61776340
PUBLIC_FORK_WORLD_ARTIFACT_COUNT = 17
PUBLIC_FORK_WORLD_ARTIFACT_SHA256 = "ffdfd8120b12b64b8a3c3c843968673648b101ac55ce3c0b9bf216570e081581"
PUBLIC_FORK_WORLD_PATH_COUNT = 19
PUBLIC_FORK_WORLD_PATH_SHA256 = "7bb85cf7cf187590b83fb45c10393aad5e811fa4437ee9b8ed939a7cb7fa4334"
PUBLIC_FORK_OFFICIAL_AUTHOR_IDENTITY_COUNT = 74
PUBLIC_FORK_EXTRA_EXACT_OFFICIAL_IDENTITY_COMMITS = 2896
PUBLIC_FORK_EXTRA_OFFICIAL_EMAIL_COMMITS = 2938
PUBLIC_FORK_WORLD_COMMIT = "cf945049f56e358809d61ba33b2c41f8204f348a"
PUBLIC_FORK_WORLD_MAP_74_BLOB = "b5e15e27ec9b8351384c7c8a20ce0b81a4553d07"
PUBLIC_FORK_WORLD_MAP_40_BLOB = "aeb6e075a63a7d249bc7814c55039a84007ae12e"
PUBLIC_FORK_WORLD_TEACHER_NOTEBOOK_BLOB = "66347c13cc0ecf7dc750f66d2a4b6a7bd099b5e6"
PUBLIC_FORK_QLIB_CHECKPOINT_BLOB = "d8689da9fd9cc37496f7cd21c75ddad1f5007bcf"
DEFAULT_PAPER_PYTHON = str(Path(__file__).resolve().parent / "run_rd_agent_mle_paper_python.sh")
PAPER_ENV_FREEZE_SHA256 = "f2dffb539b367a2eaf0799943990ec8a2f1dcc6d56a72af28d035a5fba29c52a"
...
MAIN_RESULTS = {
    "MLAB/GPT-4o": ((44.3, 2.6), (1.9, 0.7), (0, 0), (0, 0), (0.8, 0.5), (0.8, 0.5)),
    "OpenHands/GPT-4o": ((52, 3.3), (7.1, 1.7), (0.4, 0.4), (1.3, 0.8), (2.7, 1.1), (4.4, 1.4)),
    "AIDE/GPT-4o": ((54.9, 1), (14.4, 0.7), (1.6, 0.2), (2.2, 0.3), (5, 0.4), (8.7, 0.5)),
    "AIDE/o1-preview": ((82.8, 1.1), (29.4, 1.3), (3.4, 0.5), (4.1, 0.6), (9.4, 0.8), (16.9, 1.1)),
    "ML-Master/Deepseek-R1": ((93.3, 1.3), (44.9, 1.2), (4.4, 0.9), (7.6, 0.4), (17.3, 0.8), (29.3, 0.8)),
    "ML-Master/o3+GPT-4.1": ((98.2, 0.9), (25.8, 1.9), (5.8, 1.6), (3.1, 1.9), (9.3, 0.8), (18.2, 1.9)),
    "ML-Master/GPT-5": ((85.3, 3.5), (26.2, 1.6), (4.4, 1.2), (3.1, 0.4), (9.3, 0.8), (16.9, 1.2)),
    "R&D-Agent/o3+GPT-4.1": ((94.2, 0.4), (44.9, 0.4), (6.2, 0.9), (7.5, 1.2), (16, 0.8), (29.7, 0.4)),
    "R&D-Agent/GPT-5": ((96, 0), (45.3, 0), (6.7, 1.5), (12, 0.8), (16.4, 0.9), (35.1, 0.4)),
}

RESEARCH_ABLATION = {
    "avg_loops": ((45.9, 2.2), 48.4, 19.4, 55.3, 44.0),
    "improve_rate": ((41.1, 0.4), 39.4, 40.0, 23.0, 40.9),
    "first_medal_hours": ((2.9, 0.1), 1.7, 3.0, 1.7, 2.0),
    "medal_rate": ((65.8, 0.8), 50.0, 47.5, 50.0, 60.0),
    "any_medal": ((35.1, 0.4), 26.7, 25.3, 26.7, 32.0),
}
...
RUNTIME_ROWS = (
    ("MLAB/GPT-4o", 24, None),
    ("OpenHands/GPT-4o", 24, None),
    ("AIDE/GPT-4o", 24, None),
    ("AIDE/o1-preview", 24, None),
    ("ML-Master/Deepseek-R1", 12, None),
    ("KompeteAI/Gemini-2.5-flash", 6, None),
    ("MLE-STAR/Gemini-2.5-pro", 24, 8),
    ("MLE-STAR/Gemini-2.0-flash", 24, 8),
    ("AIRA/Greedy", 24, None),
    ("AIRA/MCTS", 24, None),
    ("R&D-Agent/GPT-5", 12, None),
)

CLOSED_RESULTS = {
    "InternAgent": (12, ((62.1, 3.0), (26.3, 2.6), (24.4, 2.2), (36.4, 1.2))),
    "Neo": (36, ((48.5, 1.5), (29.8, 2.3), (24.4, 2.2), (34.2, 0.9))),
...
COST_RESULTS = {
    "run_1": (4.68, 11.14, 15.82),
    "run_2": (7.85, 14.37, 22.22),
    "run_3": (8.43, 15.75, 24.18),
...
V1_RESULTS = {
    ...
    "R&D-Agent/o3+GPT-4.1/multi-trace": ((50.54, 2.51), (9.86, 3.89), (20.0, 8.16), (24.0, 0.94)),
}
...
def result_row(
    table: str, item: str, metric: str, statistic: str, value: float, unique_id: str | None = None
) -> dict[str, Any]:
...
def paper_table_rows(paper_root: Path) -> list[dict[str, Any]]:
    ...
    for competition, counts in parse_baseline_medal_rows(paper_root):
        for config, value in zip(configs, counts):
            rows.append(
                result_row("Table 9 per-competition medals", competition, config, "medals_across_three_runs", value)
            )
                ...
                rows.append(
                    {
                        ...
                        "metric": f"{difficulty}_any_medal",
                        "statistic": statistic,
                        "value": fmt(value),
...
def version_summary_rows() -> list[dict[str, Any]]:
    return [
        {
            "release": "arXiv v1",
            "date": VERSIONS["v1"]["date"],
            "pages": 7,
            "numeric_table_cells": 32,
            "runtime_hours": 24,
            "reported_error": "standard deviation",
            "reported_seed_count": "5 for o1; 6 for o3+GPT-4.1",
            "result_authority": False,
            "notes": "four configurations by Lite/Medium/High/All any-medal rate; includes o1 and two-trace fusion",
        },
        {
            "release": "arXiv v2",
            "date": VERSIONS["v2"]["date"],
            "pages": 33,
            "numeric_table_cells": 534,
            "runtime_hours": 12,
            "reported_error": "SEM",
            "reported_seed_count": "3",
        ...
        {
            "release": "official README current",
            "date": SOURCE_CURRENT_DATE,
            "pages": "",
            "numeric_table_cells": 32,
            "runtime_hours": 24,
            "reported_error": "standard deviation",
...
MECHANISMS = (
    (
        "research_development_separation",
        "separate research proposal and development execution phases",
        "rdagent/scenarios/data_science/loop.py",
        ("propose", "develop"),
        "implementation present",
    ),
    (
        "dynamic_time_planning",
        "time-aware draft/model-architecture planning",
        "rdagent/scenarios/data_science/proposal/exp_gen/planner/__init__.py",
        ("remain_percent", "suggest_model_architecture"),
        "implementation present but enable_planner defaults false",
    ),
    (
        "research_DAG",
        "DAG-backed experiment trace with parent selections",
        "rdagent/scenarios/data_science/proposal/exp_gen/base.py",
        ("dag_parent", "sync_dag_parent_and_hist", "get_leaves"),
        "implementation present",
    ),
    (
        "parallel_multi_trace",
        "parallel trace exploration",
        "rdagent/scenarios/data_science/proposal/exp_gen/router/__init__.py",
        ("class ParallelMultiTraceExpGen", "DS_RD_SETTING.max_trace_num"),
        "implementation present but max_trace_num defaults one",
    ),
    (
        "interaction_kernel",
        "cosine similarity plus tanh score difference and exponential path decay",
        "rdagent/scenarios/data_science/proposal/exp_gen/proposal.py",
        (
            "alpha * sim_matrix * math.exp(-gamma * path_length)",
            "torch.tanh(score_diff_matrix)",
            "torch.clamp(logits, min=-2, max=2)",
        ),
        "paper equation is implemented with alpha=beta=1 and gamma=ln(2)/30",
    ),
    (
        "probabilistic_history_sampling",
        "softmax/categorical historical-hypothesis sampling",
        "rdagent/scenarios/data_science/proposal/exp_gen/proposal.py",
        ("torch.softmax", "torch.multinomial", "n_samples = min(2"),
        "implementation present",
    ),
    (
        "adaptive_hypothesis_selection",
        "LLM select/modify/generate from candidates",
        "rdagent/scenarios/data_science/proposal/exp_gen/proposal.py",
        ("llm_select_hypothesis", "select_hypothesis"),
        "implementation present but llm_select_hypothesis defaults false",
    ),
    (
        "round_robin_scheduler",
        "round-robin trace scheduler",
        "rdagent/scenarios/data_science/proposal/exp_gen/trace_scheduler.py",
        ("class RoundRobinScheduler", "return trace.NEW_ROOT"),
        "default scheduler exists but is not the paper's probabilistic interaction kernel",
    ),
    (
        "probabilistic_scheduler",
        "potential-weighted leaf scheduler",
        "rdagent/scenarios/data_science/proposal/exp_gen/trace_scheduler.py",
        ("class ProbabilisticScheduler", "_softmax_probabilities"),
        "implementation present but not the default scheduler",
    ),
    (
        "collaborative_memory",
        "cross-trace diversity and idea context",
        "rdagent/scenarios/data_science/proposal/exp_gen/idea_pool.py",
        ("class DSIdea", "class DSKnowledgeBase"),
        "implementation present; paper run state absent",
    ),
    (
        "scientific_hypothesis_pipeline",
        "problem identification and hypothesis-driven proposal",
        "rdagent/scenarios/data_science/proposal/exp_gen/prompts_v2.yaml",
        ("hypothesis", "problem"),
        "prompt implementation present; exact run prompts/responses absent",
    ),
    (
        "hypothesis_critique_rewrite",
        "critique and rewrite stage",
        "rdagent/scenarios/data_science/proposal/exp_gen/proposal.py",
        ("Hypothesis critique and rewrite", "enable_hypo_critique_rewrite"),
        "implementation present but defaults false",
    ),
    (
        "iterative_coding_workflow",
        "LLM coder with iterative debugging",
        "rdagent/components/coder/CoSTEER/__init__.py",
        ("class CoSTEER", "evolving_trace"),
        "generic CoSTEER implementation is used by the data-science runner",
    ),
    (
        "sampled_debug_data",
        "debugging on sampled data before full execution",
        "rdagent/scenarios/data_science/scen/__init__.py",
        ("sample_data_by_LLM", "recommend_debug_timeout"),
        "implementation present and source default enabled",
    ),
    (
        "execution_and_score_validation",
        "execute generated workflow and validate scores.csv",
        "rdagent/scenarios/data_science/dev/runner/eval.py",
        ("scores.csv", "DSRunnerEvaluator", "ensemble"),
        "implementation present",
    ),
    (
        "evaluation_alignment_feedback",
        "LLM checks evaluation alignment and replacement decision",
        "rdagent/scenarios/data_science/dev/feedback.py",
        ("Evaluation Aligned With Task", "Replace Best Result"),
        "implementation present",
    ),
    (
        "best_valid_selector",
        "rank valid candidates by validation score",
        "rdagent/scenarios/data_science/proposal/exp_gen/select/submit.py",
        ("class BestValidSelector", "collect_sota_candidates"),
        "implementation present",
    ),
    (
        "holdout_revalidation",
        "candidate re-evaluation on a common synthetic holdout",
        "rdagent/scenarios/data_science/proposal/exp_gen/select/submit.py",
        ("class ValidationSelector", "sample_rate: float = 0.8"),
        "implementation present but default is 80/20, not paper's 90/10",
    ),
    (
        "submission_validation",
        "MLE-Bench submission-format/test evaluation",
        "rdagent/scenarios/data_science/dev/runner/eval.py",
        ("get_test_eval", "Submission check"),
        "implementation present",
    ),
    (
        "optional_RAG",
        "optional external knowledge base",
        "rdagent/app/data_science/conf.py",
        ("enable_knowledge_base: bool = False", "knowledge_base_path"),
        "implementation hook present and defaults false",
    ),
    (
        "MLE_Bench_environment",
        "MLE-Bench evaluator/runtime image",
        "rdagent/scenarios/kaggle/docker/mle_bench_docker/Dockerfile",
        ("github.com/openai/mle-bench.git", "git lfs pull"),
        "implementation present but upstream clone is unpinned",
    ),
)
        ...
        rows.append(
            {
                ...
                "paper_era_source_path": path,
                "required_source_tokens_found": present,
                "source_evidence": caveat,
                ...
                "paper_mechanism_execution_credit": False,
                "paper_result_credit": False,
            }
        )
...
def config_rows(source_root: Path) -> list[dict[str, Any]]:
    ...
    selector = git_show(
        source_root, SOURCE_V2_COMMIT, "rdagent/scenarios/data_science/proposal/exp_gen/select/submit.py"
    )
    docker = git_show(source_root, SOURCE_V2_COMMIT, "rdagent/scenarios/kaggle/docker/mle_bench_docker/Dockerfile")
    configs = [
        (
            "runtime per competition",
            "12 hours",
            "runner CLI accepts a timeout but no paper command/config is released",
            "unverified",
        ),
        ...
        (
            "API provider",
            "Azure OpenAI",
            "general API configuration exists; paper deployment/version absent",
            "unverified",
        ),
        (
            "benchmark",
            "75 MLE-Bench competitions",
            "Dockerfile clones MLE-Bench live without a commit",
            "mismatch_unpinned" if "git clone https://github.com/openai/mle-bench.git" in docker else "missing",
        ),
        ("difficulty counts", "22 Lite, 38 Medium, 15 High", "paper only; frozen task manifest absent", "missing"),
        (
            "planner enabled",
            "dynamic planning",
            "enable_planner defaults false",
            "mismatch_default" if "enable_planner: bool = False" in conf else "unverified",
        ),
        (
            "trace scheduler",
            "adaptive exploration",
            "default is RoundRobinScheduler",
            "mismatch_default"
            if 'trace_scheduler: str = "rdagent.scenarios.data_science.proposal.exp_gen.trace_scheduler.RoundRobinScheduler"'
            in conf
            else "unverified",
        ),
        (
            "trace count",
            "parallel/multi-trace design",
            "max_trace_num defaults 1",
            "mismatch_default" if "max_trace_num: int = 1" in conf else "unverified",
        ),
        (
            "LLM hypothesis selector",
            "enabled in described algorithm",
            "llm_select_hypothesis defaults false",
            "mismatch_default" if "llm_select_hypothesis: bool = False" in conf else "unverified",
        ),
        (
            "hypothesis critique/rewrite",
            "scientific multi-step reasoning",
            "enable_hypo_critique_rewrite defaults false",
            "mismatch_default" if "enable_hypo_critique_rewrite: bool = False" in conf else "unverified",
        ),
        (
            "sampled debugging",
            "enabled",
            "sample_data_by_LLM defaults true",
            "source_default_matches" if "sample_data_by_LLM: bool = True" in conf else "unverified",
        ),
        (
            "debug timeout",
            "not separately specified in paper",
            "600 seconds",
            "source_only" if "debug_timeout: int = 600" in conf else "missing",
        ),
        (
            "full-run timeout",
            "bounded by 12-hour overall budget",
            "3600 seconds per execution",
            "source_only" if "full_timeout: int = 3600" in conf else "missing",
        ),
        (
            "holdout split",
            "stratified 90/10",
            "ValidationSelector defaults sample_rate=0.8",
            "mismatch_default" if "sample_rate: float = 0.8" in selector else "unverified",
        ),
        (
            "interaction alpha",
            "1.0 in source implementation",
            "alpha=1.0",
            "source_matches" if "alpha, beta = 1.0, 1.0" in proposal else "missing",
        ),
        (
            "interaction beta",
            "1.0, or 0 before a SOTA exists",
            "beta=1.0/0",
            "source_matches" if "alpha, beta = 1.0, 0" in proposal else "missing",
        ),
        (
            "interaction gamma",
            "decay factor; appendix omits numeric value",
            "ln(2)/30",
            "source_resolves_paper_omission" if "gamma = math.log(2) / 30" in proposal else "missing",
        ),
        (
            "interaction clamp",
            "[-2,2]",
            "torch.clamp min=-2 max=2",
            "source_matches" if "torch.clamp(logits, min=-2, max=2)" in proposal else "missing",
        ),
        (
            "history samples",
            "n unspecified",
            "at most 2 plus global best",
            "source_resolves_paper_omission" if "n_samples = min(2, num_candidates)" in proposal else "missing",
        ),
        (
            "fixed seed/data split",
            "three independent runs",
            "fix_seed_and_data_split defaults false",
            "unverified" if "fix_seed_and_data_split: bool = False" in conf else "missing",
        ),
        (
            "RAG knowledge base",
            "85 non-MLE-Bench competitions",
            "disabled by default; corpus snapshot absent",
            "unverified" if "enable_knowledge_base: bool = False" in conf else "missing",
        ),
        ("raw run outputs", "three runs for two main configurations", "not included in repository", "missing"),
        (
            "cost accounting",
            "research/development API cost per competition",
            "request logs and pricing snapshot absent",
            "missing",
        ),
        (
            "baseline revisions",
            "official results plus ML-Master re-evaluations",
            "commits/configs/hardware images not pinned",
            "missing",
        ),
    ]
    return [
        {
            ...
            "released_source_evidence": source_value,
            "status": status,
            "verified_for_reported_run": False,
...
def source_snapshot_rows(source_root: Path) -> list[dict[str, Any]]:
    ...
    for label, commit, date, cutoff in specs:
        ...
        result_like = [
            ...
            if re.search(r"(^|/)(results?|outputs?|logs?|traces?|checkpoints?)(/|\.|$)", name, re.I)
        ]
        rows.append(
            {
                "snapshot": label,
                "commit": commit,
                "commit_date": date,
                "cutoff_or_audit_date": cutoff,
                "tracked_files": len(names),
                "data_science_or_kaggle_files": len(relevant),
...
def _artifact_scope_summary(path: str, role: str, blob: bytes) -> str:
    ...
    if role == "between_v1_v2_39_competition_runner_ratio_diagnostic":
        rows = [
            ...
            if line.startswith("| ") and not line.startswith("| Competition") and not line.startswith("|---")
        ]
...
def public_source_history(
    ...
    official_heads = sorted({line.split(" ", 1)[1] for line in ref_lines})
    roots = sorted(str(run_git(source_root, "rev-list", *official_heads, "--max-parents=0")).splitlines())
    commits = sorted(set(str(run_git(source_root, "rev-list", *official_heads)).splitlines()))
    paths = sorted(
        {
            path
            for path in str(run_git(source_root, "log", *official_heads, "--name-only", "--format=")).splitlines()
            if path
        }
    )
    ...
    checks = {
        ...
        "remote_ref_snapshot_sha256": (bytes_sha256(ref_snapshot.encode("utf-8")) == SOURCE_HISTORY_REF_SHA256),
        ...
        "keyword_path_count": (
            sum(bool(HISTORY_KEYWORD_RE.search(path)) for path in paths) == SOURCE_HISTORY_KEYWORD_PATH_COUNT
        ),
    ...
    summary = {
        "scope": "pinned official remote branches and tags",
        ...
        "assessment": (
            "developmental_and_unrelated_branch_artifacts_exist_but_no_75_competition_three_seed_paper_run_lineage"
        ),
        "checks": checks,
    }
...
def _batch_commit_metadata(source_root: Path, commits: Sequence[str]) -> dict[str, tuple[str, str, str]]:
    env = os.environ.copy()
    ...
    for commit in commits:
        ...
        if len(header) != 3 or header[1] != "commit":
            raise RuntimeError(f"Missing fork commit object: {commit}: {header}")
        payload = process.stdout.read(int(header[2])).decode("utf-8", errors="replace")
        process.stdout.read(1)
        author = re.search(r"^author (.+) <([^>]+)> ", payload, re.MULTILINE)
        body = payload.split("\n\n", 1)[1] if "\n\n" in payload else ""
        rows[commit] = (
            author.group(1) if author else "",
            author.group(2).lower() if author else "",
    ...
    if process.returncode:
        raise RuntimeError("Fork commit metadata reader failed")
    return rows


def _batch_blob_payloads(source_root: Path, blobs: Sequence[str]) -> dict[str, bytes]:
    env = os.environ.copy()
    env["GIT_NO_LAZY_FETCH"] = "1"
    process = subprocess.Popen(
        ["git", "-C", str(source_root), "cat-file", "--batch"],
    ...
    for blob in blobs:
        ...
        if len(header) != 3 or header[1] != "blob":
            raise RuntimeError(f"Missing fork blob object: {blob}: {header}")
        payloads[blob] = process.stdout.read(int(header[2]))
        process.stdout.read(1)
    process.stdin.close()
    process.stdout.close()
    process.wait()
    if process.returncode:
        raise RuntimeError("Fork blob reader failed")
    return payloads


def _fork_complete_paper_rows(text: str, paper_groups: Mapping[tuple[str, str], Sequence[float]]) -> list[str]:
    number_pattern = re.compile(r"(?<![A-Za-z0-9_])[-+]?\d+(?:\.\d+)?(?:[eE][-+]?\d+)?")
    lower = text.lower()
    numbers = [float(value) for value in number_pattern.findall(text)]
    matches: list[str] = []
    for (table, item), values in paper_groups.items():
        distinct = sorted({value for value in values if abs(value) > 1e-12})
        if (
            item.lower() in lower
            and len(distinct) >= 4
            and all(any(abs(observed - target) < 1e-9 for observed in numbers) for target in distinct)
        ):
            matches.append(f"{table}/{item}")
    return matches


def _fork_high_relevance_role(paths: Sequence[str]) -> str:
    lower = ";".join(paths).lower()
    if "checkpoints_extended/" in lower:
        return "unrelated_qlib_checkpoint"
    if ".claude-flow/metrics/" in lower:
        return "community_infrastructure_metrics"
    if "scripts/exp/researcher/output_dir/" in lower:
        return "single_competition_example_or_idea_pool"
    if any(token in lower for token in ("qlib", "profit", "regime", "semantic")):
        return "unrelated_quant_or_semantic_result"
    if any(token in lower for token in ("sample_submission", "submission_test")):
        return "sample_or_validation_fixture"
    if "result_auto.json" in lower or "result_best_valid.json" in lower or "result_global.json" in lower:
        return "author_identity_developmental_188_item_hit_rate_output"
    return "community_nonpaper_result_or_validation_artifact"
...
def public_fork_census(
    ...
    """Audit every accessible public-fork branch without lazy-fetching irrelevant blobs."""
    if sha256(branch_ref_snapshot) != PUBLIC_FORK_SNAPSHOT_SHA256:
        raise RuntimeError("R&D-Agent public-fork branch snapshot hash changed")
    ...
    if not branch_rows or set(branch_rows[0]) != expected_columns:
        raise RuntimeError("R&D-Agent public-fork snapshot schema changed")
    branch_rows.sort(
        key=lambda row: (
    ...
    if (
        ...
        or len(fork_heads) != PUBLIC_FORK_UNIQUE_HEAD_COUNT
        or sha256_lines(fork_heads) != PUBLIC_FORK_UNIQUE_HEAD_SHA256
    ):
        raise RuntimeError("R&D-Agent public-fork branch surface changed")
    ...
    official_heads = sorted({line.split("\t", 1)[1] for line in official_ref_lines})
    if (
        len(official_heads) != PUBLIC_OFFICIAL_UNIQUE_HEAD_COUNT
        or sha256_lines(official_heads) != PUBLIC_OFFICIAL_UNIQUE_HEAD_SHA256
    ):
        raise RuntimeError("R&D-Agent official head surface changed")
    official_commits = sorted(set(str(run_git(source_root, "rev-list", *official_heads)).splitlines()))
    fork_commits = set(str(run_git(source_root, "rev-list", *fork_heads)).splitlines())
    extra_commits = sorted(fork_commits - set(official_commits))
    divergent_heads = sorted(head for head in fork_heads if head not in official_commits)
    if (
        len(official_commits) != SOURCE_HISTORY_COMMIT_COUNT
        or len(divergent_heads) != PUBLIC_FORK_DIVERGENT_HEAD_COUNT
        or sha256_lines(divergent_heads) != PUBLIC_FORK_DIVERGENT_HEAD_SHA256
        or len(extra_commits) != PUBLIC_FORK_EXTRA_COMMIT_COUNT
        or sha256_lines(extra_commits) != PUBLIC_FORK_EXTRA_COMMIT_SHA256
    ):
        raise RuntimeError("R&D-Agent divergent fork commit surface changed")
    ...
    for line in raw_lines.splitlines():
        ...
        new_blob = metadata.split()[3]
        changed_paths.add(path)
        if new_blob != "0" * 40:
            paths_by_blob[new_blob].add(path)
    ordered_paths = sorted(changed_paths)
    changed_new_blobs = sorted(paths_by_blob)
    if (
        len(ordered_paths) != PUBLIC_FORK_CHANGED_PATH_COUNT
        or sha256_lines(ordered_paths) != PUBLIC_FORK_CHANGED_PATH_SHA256
        or len(changed_new_blobs) != PUBLIC_FORK_CHANGED_NEW_BLOB_COUNT
        or sha256_lines(changed_new_blobs) != PUBLIC_FORK_CHANGED_NEW_BLOB_SHA256
    ):
        raise RuntimeError("R&D-Agent public-fork path/blob surface changed")

    base_metadata = _batch_commit_metadata(source_root, official_commits)
    extra_metadata = _batch_commit_metadata(source_root, extra_commits)
    official_identities = {(name.lower(), email) for name, email, _ in base_metadata.values()}
    official_emails = {email for _, email, _ in base_metadata.values()}
    exact_identity_extras = sum(
        (name.lower(), email) in official_identities for name, email, _ in extra_metadata.values()
    )
    official_email_extras = sum(email in official_emails for _, email, _ in extra_metadata.values())
    if (
        len(official_identities) != PUBLIC_FORK_OFFICIAL_AUTHOR_IDENTITY_COUNT
        or exact_identity_extras != PUBLIC_FORK_EXTRA_EXACT_OFFICIAL_IDENTITY_COMMITS
        or official_email_extras != PUBLIC_FORK_EXTRA_OFFICIAL_EMAIL_COMMITS
    ):
        raise RuntimeError("R&D-Agent fork author-identity surface changed")
        ...
        head_rows.append(
            {
                ...
                "reachable_from_current_official_history": head in official_commits,
                "divergent_from_current_official_history": head not in official_commits,
                "paper_result_credit": False,
            }
        )
    commit_rows = [
        {
            "commit": commit,
            "author_name": extra_metadata[commit][0],
            "author_email": extra_metadata[commit][1],
            "subject": extra_metadata[commit][2],
            "exact_author_identity_seen_in_official_history": (
                extra_metadata[commit][0].lower(),
                extra_metadata[commit][1],
            )
            in official_identities,
            "author_email_seen_in_official_history": extra_metadata[commit][1] in official_emails,
            "paper_result_credit": False,
        }
    ...
    excluded_prefixes = (
        "phase3_portfolio_ablation/",
        "app_tpl/",
        "abu-master/",
        "autoresearch_benchmarks/",
        "node_modules/",
        "docs/build",
        "docs_zh",
        "test/",
        ...
        "rdagent/coder/model_coder/",
    )
    high_paths_by_blob: dict[str, list[str]] = {}
    for blob, paths in paths_by_blob.items():
        selected = sorted(
            path
            for path in paths
            if path.lower().endswith(high_suffixes)
            and any(token in path.lower() for token in high_tokens)
            and not any(prefix in path.lower() for prefix in excluded_prefixes)
        )
        if selected:
            high_paths_by_blob[blob] = selected
    high_blobs = sorted(high_paths_by_blob)
    high_paths = sorted({path for paths in high_paths_by_blob.values() for path in paths})
    if (
        len(high_blobs) != PUBLIC_FORK_HIGH_RELEVANCE_BLOB_COUNT
        or sha256_lines(high_blobs) != PUBLIC_FORK_HIGH_RELEVANCE_BLOB_SHA256
        or len(high_paths) != PUBLIC_FORK_HIGH_RELEVANCE_PATH_COUNT
        or sha256_lines(high_paths) != PUBLIC_FORK_HIGH_RELEVANCE_PATH_SHA256
    ):
        raise RuntimeError("R&D-Agent high-relevance fork artifact surface changed")
    high_payloads = _batch_blob_payloads(source_root, high_blobs)
    if sum(len(payload) for payload in high_payloads.values()) != PUBLIC_FORK_HIGH_RELEVANCE_BYTES:
        raise RuntimeError("R&D-Agent high-relevance fork artifact bytes changed")

    paper_groups: dict[tuple[str, str], list[float]] = defaultdict(list)
    for row in paper_rows:
        paper_groups[(str(row["paper_table"]), str(row["item"]))].append(float(row["paper_value"]))
    high_artifact_rows: list[dict[str, Any]] = []
    complete_row_matches: list[str] = []
    high_text_blobs = 0
    high_binary_blobs = 0
    for blob in high_blobs:
        payload = high_payloads[blob]
        try:
            text = payload.decode("utf-8")
        except UnicodeDecodeError:
            text = ""
        if b"\0" in payload[:8192] or not text:
            high_binary_blobs += 1
            matches: list[str] = []
            content_kind = "binary"
        else:
            high_text_blobs += 1
            matches = _fork_complete_paper_rows(text, paper_groups)
            content_kind = "utf8_text"
        complete_row_matches.extend(matches)
        high_artifact_rows.append(
            {
                "git_blob": blob,
                "sha256": bytes_sha256(payload),
                "bytes": len(payload),
                "paths": ";".join(high_paths_by_blob[blob]),
                "content_kind": content_kind,
                "artifact_role": _fork_high_relevance_role(high_paths_by_blob[blob]),
                "complete_paper_result_row_matches": ";".join(matches),
                "attributable_to_published_75_competition_three_seed_run": False,
                "paper_result_credit": False,
            }
        )
    if (
        high_text_blobs != 63
        or high_binary_blobs != 2
        or complete_row_matches
        or len(high_payloads[PUBLIC_FORK_QLIB_CHECKPOINT_BLOB]) != 60211269
        or bytes_sha256(high_payloads[PUBLIC_FORK_QLIB_CHECKPOINT_BLOB])
        != "dd4d7e19ec74f03ec04921038533aa444398f25de2819b5aecc0db541578a932"
    ):
        raise RuntimeError(
            "R&D-Agent high-relevance artifact content changed: "
            f"text={high_text_blobs} binary={high_binary_blobs} "
            f"matches={complete_row_matches} "
            f"checkpoint_bytes={len(high_payloads[PUBLIC_FORK_QLIB_CHECKPOINT_BLOB])} "
            f"checkpoint_sha256={bytes_sha256(high_payloads[PUBLIC_FORK_QLIB_CHECKPOINT_BLOB])}"
        )
    ...
    world_blobs = sorted(
        ...
        for blob, paths in paths_by_blob.items()
        if any(
            path.startswith("wd/") and (path.endswith(".ipynb") or path.endswith("comp_to_scen.json")) for path in paths
        )
    )
    world_paths = sorted(
        {
            ...
            if path.startswith("wd/") and (path.endswith(".ipynb") or path.endswith("comp_to_scen.json"))
        }
    )
    if (
        len(world_blobs) != PUBLIC_FORK_WORLD_ARTIFACT_COUNT
        or sha256_lines(world_blobs) != PUBLIC_FORK_WORLD_ARTIFACT_SHA256
        or len(world_paths) != PUBLIC_FORK_WORLD_PATH_COUNT
        or sha256_lines(world_paths) != PUBLIC_FORK_WORLD_PATH_SHA256
    ):
        raise RuntimeError("R&D-Agent world-model artifact surface changed")
    world_payloads = _batch_blob_payloads(source_root, world_blobs)
    paper_competitions = {name for name, _ in parse_baseline_medal_rows(paper_root)}
    world_rows: list[dict[str, Any]] = []
    notebook_cells = 0
    notebook_outputs = 0
    notebook_executed_cells = 0
    notebook_row_matches: list[str] = []
    for blob in world_blobs:
        payload = world_payloads[blob]
        paths = sorted(
            path
            for path in paths_by_blob[blob]
            if path.startswith("wd/") and (path.endswith(".ipynb") or path.endswith("comp_to_scen.json"))
        )
        if any(path.endswith("comp_to_scen.json") for path in paths):
            mapping = json.loads(payload)
            overlap = len(set(mapping) & paper_competitions)
            cells = outputs = executed = 0
            matches: list[str] = []
            role = "competition_description_map_without_run_results"
            ...
            matches = _fork_complete_paper_rows(text, paper_groups)
            notebook_row_matches.extend(matches)
            notebook_cells += cells
            notebook_outputs += outputs
            notebook_executed_cells += executed
            overlap = entry_count = 0
            role = (
                "executed_qwen3_teacher_chain_without_medal_outputs"
                if outputs
                else "unexecuted_world_model_data_processing_notebook"
            )
        world_rows.append(
            {
                "git_blob": blob,
                ...
                "paper_75_competition_overlap": overlap,
                "notebook_cells": cells,
                "notebook_outputs": outputs,
    ...
    map_74 = json.loads(world_payloads[PUBLIC_FORK_WORLD_MAP_74_BLOB])
    map_40 = json.loads(world_payloads[PUBLIC_FORK_WORLD_MAP_40_BLOB])
    teacher_payload = world_payloads[PUBLIC_FORK_WORLD_TEACHER_NOTEBOOK_BLOB]
    if (
        len(map_74) != 74
        or len(set(map_74) & paper_competitions) != 74
        or sorted(paper_competitions - set(map_74)) != ["rsna-2022-cervical-spine-fracture-detection"]
        or len(map_40) != 40
        or len(set(map_40) & paper_competitions) != 40
        or notebook_cells != 181
        or notebook_outputs != 11
        or notebook_executed_cells != 13
        or notebook_row_matches
        or b"Qwen3ForCausalLM" not in teacher_payload
        or b"mle-bench" in teacher_payload.lower()
        or b"medal" in teacher_payload.lower()
    ):
        raise RuntimeError("R&D-Agent world-model evidence changed")
    if (
        len(world_payloads[PUBLIC_FORK_WORLD_MAP_74_BLOB]) != 16199
        or bytes_sha256(world_payloads[PUBLIC_FORK_WORLD_MAP_74_BLOB])
        != "41cd6d32c8da843eb29341405e1e40aa263f0aa693ebe9a9335d13c7eb3c3836"
        or len(world_payloads[PUBLIC_FORK_WORLD_MAP_40_BLOB]) != 8795
        or bytes_sha256(world_payloads[PUBLIC_FORK_WORLD_MAP_40_BLOB])
        != "7db80fd34915fd08aabf6dc76f26fbc6d1a20b9b72d9ada2a3d7e9c5cfd6a27b"
        or len(teacher_payload) != 4931000
        or bytes_sha256(teacher_payload) != "eff875087fd9482b2ecd3094d01510fbf5e5816a8dfc0a72d9886ba2032a4371"
    ):
        raise RuntimeError("R&D-Agent pinned world-model blob changed")

    world_refs = [
        row for row in branch_rows if row["branch"] == "world_model" and row["head_commit"] == PUBLIC_FORK_WORLD_COMMIT
    ]
    world_author = extra_metadata[PUBLIC_FORK_WORLD_COMMIT]
    if len(world_refs) != 16 or world_author[:2] != ("jingyuanlm", "842442862@qq.com"):
        raise RuntimeError("R&D-Agent world-model provenance changed")

    high_blob_set = set(high_blobs)
    world_blob_set = set(world_blobs)
    path_rows: list[dict[str, Any]] = []
    for path in ordered_paths:
        blobs = {blob for blob, paths in paths_by_blob.items() if path in paths}
        if blobs & world_blob_set:
            role = "preserved_world_model_development_artifact"
        elif blobs & high_blob_set:
            role = "high_relevance_result_or_data_artifact_reviewed"
        elif path.startswith(("phase3_portfolio_ablation/", "app_tpl/")):
            role = "unrelated_quant_extension"
        elif HISTORY_KEYWORD_RE.search(path):
            role = "result_like_source_template_test_or_unrelated_extension"
        else:
    ...
    summary = {
        ...
        "repositories_with_more_than_100_branches": 153,
        "unique_heads": len(fork_heads),
        "heads_reachable_from_current_official_history": len(fork_heads) - len(divergent_heads),
        "divergent_heads_reviewed": len(divergent_heads),
        "divergent_extra_commits_reviewed": len(extra_commits),
        "divergent_changed_paths_reviewed": len(ordered_paths),
        "divergent_changed_new_blobs_inventoried": len(changed_new_blobs),
        "official_history_author_identities": len(official_identities),
        "extra_commits_with_exact_official_author_identity": exact_identity_extras,
        "extra_commits_with_official_author_email": official_email_extras,
        "high_relevance_result_or_data_blobs_reviewed": len(high_blobs),
        "high_relevance_result_or_data_paths_reviewed": len(high_paths),
        "high_relevance_bytes_reviewed": sum(len(value) for value in high_payloads.values()),
        "high_relevance_text_blobs_reviewed": high_text_blobs,
        "high_relevance_binary_blobs_reviewed": high_binary_blobs,
        "high_relevance_complete_paper_result_rows": 0,
        "world_model_competition_map_entries": 74,
        "world_model_competition_map_paper_overlap": 74,
        "world_model_missing_paper_competition": "rsna-2022-cervical-spine-fracture-detection",
        "world_model_notebook_blobs_reviewed": 15,
        "world_model_notebook_cells": notebook_cells,
        "world_model_notebook_outputs": notebook_outputs,
        "world_model_notebook_executed_code_cells": notebook_executed_cells,
        "world_model_notebook_complete_paper_result_rows": 0,
        "world_model_preserving_fork_refs": len(world_refs),
        "world_model_commit_author_name_matches_paper_coauthor": True,
        "world_model_commit_author_email_matches_paper": False,
        "world_model_identity_interpretation": "name_match_only_not_independently_verified",
        "attributable_published_run_artifacts": 0,
        "paper_result_cells_reproduced_from_forks": 0,
        "paper_result_credit": False,
    }
    return (
        branch_rows,
...
def paper_asset_rows(paper_root: Path) -> list[dict[str, Any]]:
    result_assets = {
        "agent_performance_compact_new.pdf",
        "backend_comparison.pdf",
        "development_ablation_narrow.png",
        "lite_performance_comparison.pdf",
    }
    rows = []
...
def internal_check_rows() -> list[dict[str, Any]]:
    checks = [
        ...
        (
            "v1 to v2 protocol",
            "runtime changes 24h to 12h; configurations, metrics, seeds, and error statistic change",
            "material_noncomparable_revision",
            False,
        ),
        (
            "raw GPT-5 summary",
            "rounded raw runs reconstruct all six means/SEMs to displayed precision",
            "pass_with_rounded_inputs",
            True,
        ),
        (
            "raw hybrid summary",
            "rounded raw runs imply Valid Submission SEM 0.5, while Table 2 prints 0.4; hidden precision may explain it",
            "not_reconstructable_from_displayed_raw_values",
            False,
        ),
        (
            "ML-Master GPT-5 uncertainty",
            "main prose says Any Medal 16.9±2.0, Table 2 and Figure 1 say 16.9±1.2",
            "contradiction",
            False,
        ),
        (
            "hybrid backend result",
            "Appendix backend figure says 29.3%, while Table 2 reports hybrid 29.7±0.4%",
            "contradiction_or_different_unidentified_run",
            False,
        ),
        (
            "Table 9 hybrid aggregation",
            "hybrid medal counts sum to 66/225=29.3%, but Table 7 raw Any-Medal rows imply 67/225=29.8% and Table 2 prints 29.7±0.4%; the paper does not identify separate run sets",
            "contradiction_or_mixed_run_sets",
            False,
        ),
        ...
        (
            "Lite figure AIRA caption",
            "figure plots AIRA Greedy at 47.7 while caption says AIRA reported value is 0",
            "contradiction",
            False,
        ),
        (
            "Table 9 caption",
            "caption calls two baseline configurations but table has two ML-Master and two R&D-Agent columns",
            "scope_label_error",
            False,
        ),
        (
            "paper 90/10 selector",
            "paper-era source defaults ValidationSelector to 80/20",
            "source_default_mismatch",
            False,
        ),
        (
            "paper algorithm defaults",
            "planner, LLM selection, multi-trace, and critique settings are off/one by default",
            "paper_run_configuration_absent",
            False,
        ),
        (
            "official trace links",
            "two README aka.ms result links redirect to generic Bing pages at audit date",
            "released_trace_links_broken",
            False,
        ),
        (
            "complete public history",
            "3,384 commits across 231 remote branch/tag refs contain developmental diagnostics but no attributable 75-competition three-seed paper-run bundle",
            "bounded_negative_result_evidence",
            False,
        ),
        (
            "complete accessible public-fork network",
            "1,854 accessible forks expose 33,775 branch refs, 1,261 unique heads, and 619 divergent heads; high-relevance outputs and preserved development notebooks add no attributable paper run",
            "bounded_negative_result_evidence",
            False,
        ),
        (
            "current README drift",
            "README retains v1-era table and reports hybrid 30.22±1.5, not final-paper 29.7±0.4",
            "release_documentation_drift",
            False,
        ),
        (
            "source compilation",
            "38 paper-era data-science Python files compile; compilation is not execution",
            "component_packaging_pass",
            True,
        ),
        ("paper source compilation", "v2 LaTeX compiles to 33 pages", "paper_packaging_pass", True),
        (
            "quant mapping boundary",
            "primary paper evaluates MLE-Bench; later quant scenario code is not evidence for these results",
            "correct_scope_boundary",
            True,
        ),
    ]
    return [
        {"check": name, "evidence": evidence, "status": status, "supports_replication": supports}
        for name, evidence, status, supports in checks
    ]
...
def gap_rows() -> list[dict[str, str]]:
    gaps = [
        (
            "paper run commands",
            "No exact commands or environment variables for the six v2 paper runs/ablations are released.",
        ),
        (
            "run configuration",
            "No frozen config dump proves which non-default planner, scheduler, trace, selector, critique, or merge settings were used.",
        ),
        (
            "raw traces",
            "Prompts, responses, hypotheses, DAGs, generated code, validation scores, errors, and selections are absent.",
        ),
        (
            "result artifacts",
            "Complete branch/tag history and all 1,854 accessible public forks contain developmental diagnostics, debug pickles, example outputs, preserved world-model artifacts, and run commands, but no artifact is attributable to the published 75-competition three-seed runs.",
        ),
        ...
        (
            ...
            "Exact task order, exclusions, retry policy, and Lite/Medium/High mapping artifact are absent.",
        ),
        (
            "model snapshots",
            "GPT-5, o3, GPT-4.1, o1-preview, GPT-4o, and DeepSeek deployments/revisions are not pinned.",
        ),
        (
            "API settings",
            "Temperature, top-p, max tokens, seed support, retry/backoff, timeout, and structured-output behavior are not fully pinned per role.",
        ),
        ("three seeds", "The v2 paper reports three seeds but does not list them or bind them to runs."),
        (
            "hardware image",
            "V100, 12-vCPU, and 220-GB allocations are stated but no scheduler/container digest proves the runtime image.",
        ),
        (
            "12-hour enforcement",
            "No logs establish wall-clock accounting, API wait treatment, restarts, or timeout boundaries.",
        ),
        (
            "90/10 holdout",
            "Source default is 80/20; no run override or generated split indices establish the paper's 90/10 split.",
        ),
        (
            "selection leakage",
            "The appendix selector implementation logs validation and test scores; exact held-out construction and separation from Kaggle test grading need released evidence.",
        ),
        (
            "baseline provenance",
            "Official baseline values and ML-Master re-evaluations lack pinned commits, commands, configs, seeds, and raw outputs.",
        ),
        (
            "cost derivation",
            "Token/request logs, Azure prices, currency/date, caching, retries, and failed-call accounting are absent.",
        ),
        (
            "RAG corpus",
            "The 85-competition knowledge corpus, documents, embeddings, retrieval model, and hashes are absent.",
        ),
        (
            "ablation configs",
            "Only labels are published; exact config diffs for all research/development ablations are not released.",
        ),
        ("figure inputs", "Four result figures have no plotting data or generation scripts."),
        (
            "v1/v2 provenance",
            "The report was rewritten around a new 12-hour GPT-5 experiment without a migration/result lineage document.",
        ),
        (
            "README/final mismatch",
            "The official README does not expose the final-paper GPT-5 experiment and reports different hybrid values.",
        ),
        (
            "statistical precision",
            "Only rounded raw percentages are published; at least one SEM cannot be reconstructed at displayed precision.",
        ),
        ("closed systems", "InternAgent and Neo methods/results cannot be independently audited from this repository."),
        (
            "quant lineage",
            "The retained corpus maps a quant application lineage to a general MLE-Bench primary paper; quant proxy results cannot validate this paper.",
        ),
    ]
    return [
        {"gap": name, "detail": detail, "impact": "prevents exact paper-level replication"} for name, detail in gaps
    ]
...
def validate_inputs(source_root: Path, paper_root: Path) -> None:
    ...
    expected = {
        ...
        "paper_v1.pdf": VERSIONS["v1"]["pdf_sha256"],
        "source_v1.tar": VERSIONS["v1"]["source_sha256"],
        "paper_v2.pdf": VERSIONS["v2"]["pdf_sha256"],
        "source_v2.tar": VERSIONS["v2"]["source_sha256"],
    }
...
def compile_paper(paper_root: Path, latex_command: str) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="rd-agent-paper-") as tmp:
        ...
        return {
            ...
            "status": "paper_latex_compiled_no_system_or_result_credit"
            if codes == [0, 0]
            else "paper_latex_compile_failed",
            "paper_result_credit": False,
        }
...
"""
    ...
    return {
        ...
        "status": "exact_paper_era_source_methods_executed"
        if proc.returncode == 0
        else "interaction_kernel_component_failed",
...
def dependency_environment_execution(snapshot_root: Path, paper_python: Path) -> tuple[dict[str, Any], str]:
    ...
    if freeze_sha256 != PAPER_ENV_FREEZE_SHA256:
        raise RuntimeError(f"R&D-Agent paper environment changed: {freeze_sha256} != {PAPER_ENV_FREEZE_SHA256}")
...
"""
    ...
    if (
        ...
        or imports["rdagent_direct_url"].get("vcs_info", {}).get("commit_id") != SOURCE_V2_COMMIT
    ):
...
def source_component_execution(source_root: Path, component_python: str, paper_python: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="rd-agent-source-") as tmp:
        ...
        dependency_environment, dependency_freeze = dependency_environment_execution(tmp_path, paper_python)
        ...
        try:
            ...
            scheduler_passed = (
                len(probabilities) == 3
                and math.isclose(sum(probabilities), 1.0, abs_tol=1e-12)
                and probabilities[0] < probabilities[1] < probabilities[2]
            )
        finally:
        ...
        return {
            ...
            "data_science_and_kaggle_python_files_compiled": len(py_files),
            "compileall_passed": compiled,
            "native_scheduler_softmax_executed": True,
            "native_scheduler_softmax_passed": scheduler_passed,
...
GitHub reported {manifest["github_rest_reported_public_forks"]} forks on {manifest["public_fork_census_date"]}. GraphQL exposed every branch for {manifest["graphql_accessible_public_forks"]} repositories and {manifest["public_fork_branch_refs_examined"]} branch refs; the remaining {manifest["public_fork_accessibility_gap"]} deleted, private, or otherwise unavailable repositories are not claimed as inspected. The accessible surface collapses to {manifest["public_fork_unique_heads_examined"]} unique heads. Of those, {manifest["public_fork_heads_reachable_from_official_history"]} are already reachable from the pinned official history and {manifest["public_fork_divergent_heads_examined"]} diverge, adding {manifest["public_fork_divergent_extra_commits_examined"]} commits, {manifest["public_fork_divergent_changed_paths_examined"]} paths, and {manifest["public_fork_divergent_changed_new_blobs_inventoried"]} changed blob versions.

The fork network materially expands attributable development history: {manifest["public_fork_extra_commits_with_exact_official_author_identity"]} extra commits use an exact name/e-mail identity already present in official history, and {manifest["public_fork_extra_commits_with_official_author_email"]} use an official-history e-mail. This is source-lineage evidence, not proof that any commit generated a paper result. A fail-closed content review inspects {manifest["public_fork_high_relevance_blobs_reviewed"]} high-relevance result/data blobs across {manifest["public_fork_high_relevance_paths_reviewed"]} paths. It finds zero complete published result rows and no 75-competition, three-seed bundle.
...
def audit(
    ...
    (
        ...
        fork_paths,
        fork_artifacts,
        fork_world_artifacts,
        fork_summary,
    ) = public_fork_census(source_root, paper_root, table, fork_snapshot)
    assets = paper_asset_rows(paper_root)
    checks = internal_check_rows()
    gaps = gap_rows()
    source_execution = source_component_execution(source_root, component_python, paper_python)
    ...
    native = {
        ...
        "credential_presence": {
            ...
            for name in ("OPENAI_API_KEY", "AZURE_OPENAI_API_KEY", "KAGGLE_USERNAME", "KAGGLE_KEY")
        },
    ...
    links = [
        {
            "label": "o1-preview detailed results",
            "url": "https://aka.ms/RD-Agent_MLE-Bench_O1-preview",
            "audit_date": AUDIT_DATE,
            "resolved_url": "https://www.bing.com/?ref=aka&shorturl=RD-Agent_MLE-Bench_O1-preview",
            "status": "broken_redirect_to_generic_bing_no_trace_artifact",
            "paper_result_credit": False,
        },
        {
            "label": "o3+GPT-4.1 detailed results",
            "url": "https://aka.ms/RD-Agent_MLE-Bench_O3_GPT41",
            "audit_date": AUDIT_DATE,
            "resolved_url": "https://www.bing.com/?ref=aka&shorturl=RD-Agent_MLE-Bench_O3_GPT41",
            "status": "broken_redirect_to_generic_bing_no_trace_artifact",
            "paper_result_credit": False,
        },
    ]
    ...
    csv_outputs = {
        ...
        "public_fork_divergent_commit_inventory.csv": fork_commits,
        "public_fork_divergent_path_inventory.csv": fork_paths,
        "public_fork_high_relevance_artifact_inventory.csv": fork_artifacts,
        "public_fork_world_model_artifact_inventory.csv": fork_world_artifacts,
    ...
    (output / "paper_era_environment_freeze.txt").write_text(dependency_freeze, encoding="utf-8")
    ...
    manifest: dict[str, Any] = {
        ...
        "paper_url": ARXIV_URL,
        "paper_hashes": {
            f"arxiv_{version}_{kind}": data[f"{kind}_sha256"]
        ...
        "overall_status": "paper_specification_source_official_history_and_1854_forks_audited_zero_native_results_missing_attributable_run_artifacts",
        ...
        "paper_mechanisms_with_source_implementation": sum(
            bool(row["required_source_tokens_found"]) for row in mechanisms
        ),
        ...
        "public_source_history_artifact_candidates_inspected": history["bounded_artifact_candidates_inspected"],
        "public_source_history_attributable_paper_run_artifacts": history["attributable_published_run_artifacts"],
        "paper_result_cells_reproduced_from_public_history": history["paper_result_cells_reproduced_from_history"],
        ...
        "public_fork_repositories_with_more_than_100_branches": fork_summary[
            "repositories_with_more_than_100_branches"
        ],
        ...
        "public_fork_divergent_changed_new_blobs_inventoried": fork_summary["divergent_changed_new_blobs_inventoried"],
        ...
        "public_fork_extra_commits_with_official_author_email": fork_summary[
            "extra_commits_with_official_author_email"
        ],
        "public_fork_high_relevance_blobs_reviewed": fork_summary["high_relevance_result_or_data_blobs_reviewed"],
        "public_fork_high_relevance_paths_reviewed": fork_summary["high_relevance_result_or_data_paths_reviewed"],
        "public_fork_high_relevance_complete_paper_result_rows": 0,
        "public_fork_world_model_competition_map_entries": fork_summary["world_model_competition_map_entries"],
        "public_fork_world_model_competition_map_paper_overlap": fork_summary[
            "world_model_competition_map_paper_overlap"
        ],
        "public_fork_world_model_notebook_blobs_reviewed": fork_summary["world_model_notebook_blobs_reviewed"],
        "public_fork_world_model_notebook_outputs": fork_summary["world_model_notebook_outputs"],
        "public_fork_world_model_notebook_complete_paper_result_rows": 0,
        "public_fork_attributable_published_run_artifacts": 0,
        "paper_result_cells_reproduced_from_public_forks": 0,
        ...
        "paper_era_data_science_and_kaggle_python_files_compiled": native["released_source_component_execution"][
            "data_science_and_kaggle_python_files_compiled"
        ],
        "paper_era_scheduler_component_executed": native["released_source_component_execution"][
            "native_scheduler_softmax_passed"
        ],
        "paper_era_interaction_kernel_executed": native["released_source_component_execution"][
            "native_interaction_kernel_execution"
        ]["passed"],
        "paper_era_dependency_environment_reproduced": native["released_source_component_execution"][
            "dependency_environment"
        ]["dependency_environment_reproduced"],
        "paper_era_exact_historical_dependency_versions_recovered": native["released_source_component_execution"][
            "dependency_environment"
        ]["exact_historical_dependency_versions_recovered"],
        "paper_era_source_modules_imported": native["released_source_component_execution"]["dependency_environment"][
            "imported_source_modules"
        ],
        "paper_era_upstream_offline_tests_passed": native["released_source_component_execution"][
            "dependency_environment"
        ]["upstream_offline_tests_passed"],
        "paper_era_mle_bench_container_reproduced": native["released_source_component_execution"][
            "dependency_environment"
        ]["mle_bench_container_reproduced"],
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--fork-snapshot", type=Path, required=True)
