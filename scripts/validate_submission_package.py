...
REQUIRED_PATHS = (
    ...
    Path("docs/FIDELITY_AUDIT.md"),
    Path("docs/faithful_component_owner_review_packet.md"),
    Path("docs/EXPERIMENT_INDEX.md"),
    Path("docs/DATA_AND_ARTIFACTS.md"),
    Path("docs/INDEPENDENT_MAPPING_REVIEW_PLAN.md"),
    ...
    Path("scripts/run_faithful_component_replications.py"),
    Path("scripts/validate_faithful_component_replications.py"),
    Path("scripts/check_upstream_conformance.py"),
    Path("scripts/validate_owner_review_attestation.py"),
    Path("paper_runs/faithful_component_replications/manifest.json"),
    Path("paper_runs/faithful_component_replications/faithfulness_ledger.csv"),
    Path("paper_runs/faithful_component_replications/upstream_conformance.json"),
    Path("paper_runs/faithful_component_replications/owner_review_attestation.csv"),
    Path("tests/upstream_snapshots/quantevolver/examples/seed_candidates.yaml"),
    Path("tests/upstream_snapshots/quantevolver/quant_evolver/dsl/evaluator.py"),
    Path("tests/upstream_snapshots/quantevolver/quant_evolver/evaluation/cross_sectional_rankic.py"),
    Path("tests/upstream_snapshots/quantevolver/LICENSE"),
    Path("paper_runs/faithful_component_replications/attribution_manifest.json"),
    Path("paper_runs/faithful_component_replications/attribution_results.csv"),
    Path("paper_runs/faithful_component_replications/attribution_summary.csv"),
    Path("paper_runs/faithful_component_replications/closest_jkp_factors.csv"),
    Path("docs/paper/tables/faithful_component_census.tex"),
    CANONICAL_SOURCE,
    CANONICAL_PDF,
    *HANDOFF_FILES,
)
