...
| Mapping and attribution audit | Frozen: 62 mappings, including 50 from 40 retained papers | `scripts/build_mapping_audit.py`, `scripts/build_source_anchor_review_packet.py` | `paper_runs/submission_evidence/mapping_audit/` | Source papers for independent re-review | Mappings were not outcome-blind and lacked an independent second coder |
...
| Paper assets and PDF | Canonical evidence-audit artifact; current strict validator blocker documented | `scripts/build_icaif2026_submission_assets.py`, `scripts/build_icaif2026_submission.py`, `scripts/validate_icaif_submission.py` | `docs/paper/`, `output/pdf/icaif2026_submission.pdf`, `docs/VALIDATION_STATUS.md` | TeX Live/Poppler for compilation and rendering | Canonical PDF passes 65/71 strict format checks and is distinct from the later benchmark-ladder extension |
