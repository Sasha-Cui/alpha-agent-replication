...
| Paper assets and PDF | Current: seven-page anonymous ICAIF submission; 71/71 format checks and locked-evidence validation pass | `scripts/build_icaif2026_submission_assets.py`, `scripts/build_icaif2026_submission.py`, `scripts/validate_submission_package.py` | `docs/paper/`, `output/pdf/icaif2026_submission.pdf`, `docs/VALIDATION_STATUS.md` | TeX Live/Poppler for compilation and rendering | Canonical paper includes the matched benchmark ladder; older evidence-audit source remains research provenance only |
