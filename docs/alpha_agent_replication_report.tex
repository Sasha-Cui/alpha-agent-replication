...
\fcolorbox{red!75!black}{red!5}{%
  \parbox{0.92\linewidth}{%
    ...
    \textbf{\Large SUPERSEDED / INVALIDATED}\\[0.35em]
    \textbf{DO NOT USE THIS LEGACY REPORT FOR CURRENT CLAIMS OR RESULTS.}\\[0.35em]
    This document is retained only for provenance. Use the current claim boundary
    \texttt{docs/FIDELITY\_AUDIT.md}, the current manuscript
    \texttt{docs/paper/icaif2026\_submission.tex} (built PDF:
    \texttt{output/pdf/icaif2026\_submission.pdf}) and the current fidelity
    evidence in
    \texttt{paper\_runs/submission\_evidence/native\_fidelity\_ledger.csv}
    and
    \texttt{paper\_runs/submission\_evidence/artifact\_audit/}.
    Claims, counts, and interpretations below are not authoritative for the
    current submission.
  }%
}
\end{center}
